...
func main() {
	...
	msgHandlers := handlers.ProcessLinear(
		...
		handlers.RespondWhenContains([]string{"︵", "彡"}, handlers.Contains, "┬─┬ノ( º _ ºノ)"),
		...
		handlers.WhenDirectedToBot(handlers.ProcessLinear(
			...
			handlers.RespondWhenExact([]string{"recommended", "recommended blogs"},
				strings.Join([]string{
			...
			handlers.RespondWhenExact([]string{"books"},
				strings.Join([]string{
			...
			handlers.RespondWhenExact([]string{"oss help", "oss help wanted"},
			...
			handlers.RespondWhenExact([]string{"slices", "slice internals"},
				strings.Join([]string{
			...
			handlers.RespondWhenExact([]string{"databases", "database tutorial"},
				`Here's how to work with database/sql in Go: <http://go-database-sql.org/>`,
			),
			handlers.RespondWhenExact(
				[]string{
					"project layout",
					"package layout",
					"project structure",
